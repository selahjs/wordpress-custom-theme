...
<head>
    ...
    <link rel="shortcut icon" href="<?php get_template_directory_uri().'/logo.png' ?>">
    
    
    <?php
    // the wp_head() call adds meta tags, loads stylsheedts, loads scripts etc.. that are defined inside function.php
    wp_head();
    ?>
